...
public class SolidWall extends GameObjects {      //NOTE: this class is only used to handle border(unbreakable) walls and background walls(it handles both, because they have identical functionality), breakable walls are handled in the BreakableWall class
    ...
    public SolidWall(int x, int y, boolean is_background) {
        this.x = x;
        this.y = y;
