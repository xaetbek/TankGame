...
public class BreakableWall extends SolidWall {
    ...
    BreakableWall(int x, int y) {
        this.x = x;
        this.y = y;
        this.bounds = new Rectangle(x, y, breakable_wall_img.getWidth(), breakable_wall_img.getHeight());
    }
    ...
    static void set_breakable_wall_img(BufferedImage image) {
        main.java.tankrotationexample.BreakableWall.breakable_wall_img = image;
    }
